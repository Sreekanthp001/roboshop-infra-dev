module "mongodb" {
    ...
    source = "git::https://github.com/Sreekanthp001/terraform-aws-securitygroup.git?ref=main"
    project = var.project
...
resource "aws_security_group_rule" "shipping_bastoin_ssh" {
  type              = "ingress"
  from_port         = 22
  to_port           = 22
  protocol          = "tcp"
